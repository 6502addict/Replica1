...
entity CPU_MX65 is
    port (
        ...
        so_n        : in  std_logic;        -- Set overflow (active low)
...
architecture MX65_impl of CPU_MX65 is
    ...
    component mx65 is
        port (
            ...
            nmi         : in  std_logic;                      -- NMI (active low)
            irq         : in  std_logic;                      -- IRQ (active low)
            so          : in  std_logic                       -- IRQ (active low)
    );
    end component;
